...
# Kernel
LOCAL_KERNEL := device/xiaomi/umi-kernel/Image
PRODUCT_COPY_FILES += \
    $(LOCAL_KERNEL):kernel

# Kernel headers
PRODUCT_VENDOR_KERNEL_HEADERS := device/xiaomi/umi-kernel/kernel-headers
...
# Power
PRODUCT_PACKAGES += \
    android.hardware.power-service.xiaomi_umi-libperfmgr
